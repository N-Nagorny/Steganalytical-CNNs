...
mkdir -p BOSSbase_1.01-$SIZE/stego
...
do
    ...
    if [ $(( I%1000 )) == 0 ]; then
        ...
        mkdir -p BOSSbase_1.01-$SIZE/stego/$DIRNAME
    fi
...
for I in {0..9}
do
    ./WOW_linux_make_v10/executable/WOW -v -I BOSSbase_1.01-$SIZE/cover/$I/ -O BOSSbase_1.01-$SIZE/stego/$I/ -a 0.4
done
